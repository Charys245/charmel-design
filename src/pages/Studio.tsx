    ...
    <div className="min-h-screen bg-light text-black">
      ...
      <section className="pt-40 md:pt-48 pb-20 md:pb-28">
        <div className="mx-auto max-w-400 px-6 md:px-10">
          <p className="eyebrow text-black/60 mb-8">— The Studio</p>
          <Heading as="h1" className="font-bold max-w-6xl">
            A design practice for <span className="text-yellow">brand builders.</span>
          </Heading>
        </div>
      </section>
      ...
      <section className="pb-24 md:pb-32">
        <div className="mx-auto max-w-400 px-6 md:px-10 grid grid-cols-12 gap-8">
          <div className="col-span-12 md:col-span-5">
            <p className="eyebrow text-black/50 mb-4">Vision</p>
            <p className="font-display text-2xl leading-tight">
              A new generation of design — strategic, editorial, built to scale.
            </p>
          </div>
          <div className="col-span-12 md:col-span-7 space-y-6 text-black/75 text-lg leading-relaxed">
            <p>
              I work at the intersection of <strong className="text-black">strategy and craft</strong>
      ...
      {/* TIMELINE */}
      <section className="bg-black text-light py-24 md:py-32">
        <div className="mx-auto max-w-400 px-6 md:px-10">
          ...
          <div className="border-t border-light/15">
            {timeline.map((t, i) => (
              <div
                key={t.year}
                className="grid grid-cols-12 gap-6 py-8 md:py-10 border-b border-light/15 group hover:bg-yellow hover:text-black transition-colors duration-500 px-2 -mx-2 cursor-default"
              >
      ...
      <section className="py-24 md:py-32">
        <div className="mx-auto max-w-400 px-6 md:px-10 text-center">
          <p className="eyebrow text-black/60 mb-6">— Currently</p>
          ...
          <Link
            to="/contact"
            className="inline-flex items-center gap-3 mt-10 bg-black text-light px-7 py-4 hover:bg-yellow hover:text-black transition-colors"
          >
